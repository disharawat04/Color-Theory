...
const redWireframeMaterial = new THREE.LineBasicMaterial({ color: 0xff0000 });
const greenWireframeMaterial = new THREE.LineBasicMaterial({ color: 0x0000ff });
const blueWireframeMaterial = new THREE.LineBasicMaterial({ color: 0xFFFF00 });
...
// Create wireframe materials
const redWireframeMaterial = new THREE.PointsMaterial({ color: 0xff0000, size: 0.05 });
const greenWireframeMaterial = new THREE.PointsMaterial({ color:  0xFFFF00, size: 0.05 });
const blueWireframeMaterial = new THREE.PointsMaterial({ color: 0x0000ff, size: 0.05 });

// Create wireframe geometries for the cubes
const redWireframeGeometry = new THREE.BoxGeometry();
const greenWireframeGeometry = new THREE.BoxGeometry();
const blueWireframeGeometry = new THREE.BoxGeometry();

// Create wireframe point clouds for the cubes
const redWireframeCube = new THREE.Points(redWireframeGeometry, redWireframeMaterial);
const greenWireframeCube = new THREE.Points(greenWireframeGeometry, greenWireframeMaterial);
const blueWireframeCube = new THREE.Points(blueWireframeGeometry, blueWireframeMaterial);
